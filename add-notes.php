...
$sql="insert into tblnotes(UserID,Subject,NotesTitle,NotesDecription,File1,File2,File3,File4,url)values(:ocasuid,:subject,:notestitle,:notesdesc,:file1,:file2,:file3,:file4,:url)";
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">url</label>
                                    <input type="url" class="form-control" name="url" value="" required='true'>   
                                </div>
